	                ...
	                <li class="active">
	                    ...
	                    <div class="collapse in" id="formsExamples">
	                        <ul class="nav">
								...
								<li class="active"><a href="extended.php">Extended Forms</a></li>
			...
			<nav class="navbar navbar-default">
	            <div class="container-fluid">
	                ...
	                <div class="navbar-header">
	                    ...
	                    <a class="navbar-brand" href="#extendedforms">Extended Forms</a>
	                </div>
	                    ...
	                    <div class="content">
	                        ...
	                        <div class="row">
	                            <div class="col-md-6">
									...
									<input name="tagsinput" class="tagsinput tag-success" value="Minimal, Light, New, Friends" />
	                            ...
	                            <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <select name="cities" class="selectpicker" data-title="Single Select" data-style="btn-danger btn-block" data-menu-style="dropdown-blue">
