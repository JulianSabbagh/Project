	            ...
	            <ul class="nav">
					...
					<li class="active">
	                    ...
	                    <div class="collapse in" id="tablesExamples">
	                        <ul class="nav">
								<li class="active"><a href="regular.php">Regular Tables</a></li>
								<li><a href="extended.php">Extended Tables</a></li>
			...
			<nav class="navbar navbar-default">
	            <div class="container-fluid">
	                ...
	                <div class="navbar-header">
	                    ...
	                    <a class="navbar-brand" href="#regulartables">Regular Tables</a>
	                </div>
